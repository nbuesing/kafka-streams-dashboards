...
public class StateObserver {
    ...
    private ReadOnlyWindowStore<String, PurchaseOrder> store;
    ...
    public void start() {
        ...
        isRunning = true;
        this.store = streams.store(StoreQueryParameters.fromNameAndType("pickup-order-reduce-store", QueryableStoreTypes.windowStore()));
